...
docker exec -i kafka4ZK /bin/bash << ONION
cd /usr/kafka/kafka; bin/kafka-topics.sh --zookeeper $ipkafka4ZK:2181 --create --topic onionTopic1 --partitions 3 --replication-factor 1
ONION

docker exec -i kafka4Br1 /bin/bash << ONION
cd /usr/kafka/kafka; bin/kafka-topics.sh --zookeeper $ipkafka4ZK:2181 --create --topic onionTopic2 --partitions 3 --replication-factor 1
ONION

docker exec -i kafka4Br2 /bin/bash << ONION
cd /usr/kafka/kafka; bin/kafka-topics.sh --zookeeper $ipkafka4ZK:2181 --create --topic onionTopic3 --partitions 3 --replication-factor 1
ONION
